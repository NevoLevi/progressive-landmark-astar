...
\begin{center}
\fbox{\parbox{0.96\columnwidth}{\centering\footnotesize
\textbf{Experiment and figure-generation code:}\\[-1pt]\url{https://github.com/NevoLevi/progressive-landmark-astar/commit/4ee61db6787528efb7e01326e3c23d0006515570}}}
\end{center}
...
and analysis directory named above; a superseded or substituted artifact is
rejected.
...
method summaries, counters, and expansion digests, and validates the stored
fields against those recomputations.  The development audit records
