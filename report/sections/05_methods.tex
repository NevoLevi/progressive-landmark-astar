...
heuristic is evaluated.  Figure~\ref{fig:stages} shows the three-level schedule.

\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{stage_schematic.pdf}
  \caption{The three-level staged-evaluation schedule.  A non-goal
...
sequence.  Digest equality is checked alongside the proof and independent BFS
cost validation before performance is analyzed.
