...
All 800 sealed queries were retained.  Independent BFS and deterministic
...
checks passed before performance fields were exposed to the analysis.

\begin{table*}[t]
\centering
\small
\caption{Prospectively generated hypothesis outcomes.  H3 is descriptive;
...
Table~\ref{tab:hypotheses} reports the registered outcomes.  H2 was supported:
...
No method reopened a state.  The mean-of-query-median times in
Table~\ref{tab:methods} do not contradict the primary ratio: a ratio of paired
times and a mean of raw times are different estimands, especially under
strong map heterogeneity.
